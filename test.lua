...
do -- concatenate_
  ...
  local l2a = L.list( 3, 4 )
  local l2b = L.copy( l2a )
  local l2c = L.copy( l2a )
  local l3a = L.list( 5, 6 )
  local l3b = L.copy( l3a )
  local l4 = L.list( 1, 2, 3, 4, 5, 6 )
  assert( L.is_equal( L.concatenate_( L.list( l1a, l2a, l3a ) ), l4 ) )
  assert( L.is_equal( L.concatenate_( L.list( l1b, nil ) ), l1c ) )
  assert( L.concatenate_( L.list( l1d ) ) == l1d )
  assert( L.concatenate_( L.list( nil, l1e ) ) == l1e )
  local l5 = L.drop( L.concatenate_( L.list( l1e, l2b ) ), L.length( l1f ) )
  assert( L.is_equal( l5, l2c ) )
  assert( L.is_equal( L.concatenate_( L.list( nil, l1f, l2c, l3b ) ), l4 ) )
...
do -- map_
  ...
  local l1b = L.copy( l1a )
  local l1c = L.copy( l1a )
  local l2a = L.list( 1, 2, 3, 4, 5 )
  local l2b = L.copy( l2a )
  local l2c = L.copy( l2a )
  local l3 = L.list( 2, 4, 6, 8 )
  assert( L.is_equal( L.map_( double, l1a ), l3 ) )
  assert( L.map_( double, nil ) == nil )
  assert( L.is_equal( L.map_( add2, l1b, l2a ), l3 ) )
  assert( L.is_equal( L.map_( add2, l2b, l1c ), l3 ) )
  assert( L.map_( double, nil, l2c ) == nil )
...
do -- delete_duplicates
  ...
  local l3 = L.list( 1, 2, 1, 3, 2, 4, 4, 4, 4 )
